...
Route::prefix('publisher')->middleware('auth', 'publisher')->group(function () {
    ...
    Route::get('/infos/{id}/edit', [App\Http\Controllers\Publisher\PublisherInfoController::class, 'edit'])->name('publisher.infos.edit');
...
Route::prefix('encoder')->middleware('auth', 'encoder')->group(function () {
    ...
    Route::delete('/infos/{id}', [App\Http\Controllers\Encoder\EncoderInfoController::class, 'destroy'])->name('encoder.infos.destroy');
